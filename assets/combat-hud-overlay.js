...
.ohud-fallback {\r
  font-size: var(--ohud-font-9); font-weight: 700; color: var(--odyssey-hud-warning);\r
...
.ohud-select {\r
  font: inherit; font-size: var(--ohud-font-10); color: var(--odyssey-hud-text);\r
  background: var(--odyssey-panel-base); border: 1px solid var(--odyssey-hud-border);\r
  border-radius: 5px; padding: 1px 4px; cursor: pointer;\r
}\r
.ohud-chip {\r
  font: inherit; font-size: var(--ohud-font-10); color: var(--odyssey-hud-muted);\r
  background: var(--odyssey-panel-base); border: 1px solid var(--odyssey-hud-border);\r
...
.ohud-panel-label { font-size: var(--ohud-font-10); font-weight: 700; letter-spacing: 0.3px; color: var(--odyssey-hud-dim); }\r
.ohud-panel-body { flex: 1 1 auto; min-height: 0; display: flex; flex-direction: column; }\r
.ohud-muted-fill { color: var(--odyssey-hud-dim); font-size: var(--ohud-font-11); display: grid; place-items: center; flex: 1; }\r
\r
...
/* ===================== Player block ===================== */\r
.ohud-turn {\r
  font-size: var(--ohud-font-8-5); font-weight: 800; letter-spacing: 0.4px; padding: 1px 6px; border-radius: 7px;\r
...
.ohud-turn-round {\r
  font-size: var(--ohud-font-8-5); font-weight: 800; letter-spacing: 0.4px; padding: 1px 5px; border-radius: 7px;\r
...
.ohud-endturn-btn {\r
  ...
  font-size: var(--ohud-font-9); font-weight: 800; letter-spacing: 0.4px;\r
...
.ohud-cc-combat-btn {\r
  margin-left: auto; padding: 0 6px; font-size: var(--ohud-font-8-5); font-weight: 800; letter-spacing: 0.4px;\r
...
.ohud-gmct-current { font-size: var(--ohud-font-10); color: var(--odyssey-hud-muted); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }\r
...
.ohud-gmct-candidate { display: flex; align-items: center; gap: 6px; font-size: var(--ohud-font-11); cursor: pointer; }\r
.ohud-gmct-candidate .ohud-gmct-name { flex: 1 1 auto; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }\r
.ohud-gmct-tag { font-size: var(--ohud-font-8-5); font-weight: 800; color: var(--odyssey-hud-muted); border: 1px solid var(--odyssey-hud-border); border-radius: 6px; padding: 0 4px; }\r
...
.ohud-gmct-row { display: flex; align-items: baseline; gap: 6px; padding: 2px 0; font-size: var(--ohud-font-11); }\r
...
.ohud-gmct-btn {\r
  flex: 1 1 auto; padding: 4px 6px; font-size: var(--ohud-font-10); font-weight: 700;\r
...
.ohud-gmct-empty { padding: 8px 0; color: var(--odyssey-hud-muted); font-size: var(--ohud-font-11); }\r
\r
...
.ohud-player-name {\r
  ...
  font-size: calc(var(--ohud-font-12) * var(--ohud-critical-text-ratio, 1)); font-weight: 700; color: var(--odyssey-hud-text);\r
...
.ohud-res-label { font-size: var(--ohud-font-8); font-weight: 700; color: var(--odyssey-hud-dim); }\r
...
.ohud-res-num { font-size: calc(var(--ohud-font-10) * var(--ohud-critical-text-ratio, 1)); font-weight: 700; color: var(--odyssey-hud-text); font-variant-numeric: tabular-nums; }\r
.ohud-res-max { color: var(--odyssey-hud-dim); font-weight: 600; }\r
\r
.ohud-pips { display: flex; gap: 4px; }\r
.ohud-pip { font-size: var(--ohud-font-8); font-weight: 800; padding: 1px 6px; border-radius: 5px; border: 1px solid var(--odyssey-hud-border); }\r
...
/* Bugfix pack: MOVE's 3-state color (full/partial/empty) \u2014 color ONLY, no\r
 * number/meter/bar anywhere near it. "empty" intentionally matches .is-off\r
 * exactly (same dim/gray treatment MAIN already uses when spent). */\r
.ohud-pip--move-full { color: #06210f; background: var(--odyssey-hud-state-active); border-color: transparent; }\r
.ohud-pip--move-partial { color: #2b2106; background: var(--odyssey-hud-warning); border-color: transparent; }\r
.ohud-pip--move-empty { color: var(--odyssey-hud-dim); }\r
\r
...
.ohud-pilot-tag { font-size: var(--ohud-font-7-5); font-weight: 800; letter-spacing: 0.8px; color: var(--odyssey-purple); }\r
.ohud-pilot-name { font-size: var(--ohud-font-10); color: var(--odyssey-hud-text); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }\r
.ohud-pilot-psi { margin-left: auto; font-size: var(--ohud-font-9); color: var(--odyssey-purple); }\r
\r
...
.ohud-chip-status {\r
  ...
  font-size: var(--ohud-font-8-5); padding: 1px 5px 1px 2px; border-radius: 8px;\r
  border: 1px solid var(--odyssey-hud-border); background: var(--odyssey-panel-base); color: var(--odyssey-hud-muted);\r
}\r
.ohud-chip-dot { width: 12px; height: 12px; border-radius: 50%; display: grid; place-items: center; font-size: var(--ohud-font-7); font-weight: 800; color: #0a0e18; }\r
...
.ohud-gun-name { position: absolute; top: 4px; left: 8px; font-size: calc(var(--ohud-font-9) * var(--ohud-critical-text-ratio, 1)); color: var(--odyssey-hud-muted); }\r
...
.ohud-firemode-letter {\r
  font-size: var(--ohud-font-9); font-weight: 700; color: var(--odyssey-hud-text); letter-spacing: 0.4px;\r
  white-space: nowrap; overflow: hidden; text-overflow: ellipsis;\r
}\r
...
.ohud-gun-secondary { position: absolute; left: 6px; bottom: 5px; font-size: var(--ohud-font-8); font-weight: 700; color: var(--odyssey-hud-muted); border: 1px solid var(--odyssey-hud-border); border-radius: 6px; padding: 0 5px; }\r
\r
...
.ohud-mag-type { margin-left: auto; font-size: var(--ohud-font-9); font-weight: 700; color: var(--odyssey-hud-text); }\r
...
.ohud-ammo-label { font-size: var(--ohud-font-8); letter-spacing: 0.5px; color: var(--odyssey-hud-dim); }\r
 ...
 * uses. */\r
.ohud-ammo-cur { font-size: calc(var(--ohud-font-24) * var(--ohud-critical-text-ratio, 1)); }\r
.ohud-ammo-max { font-size: calc(var(--ohud-font-11) * var(--ohud-critical-text-ratio, 1)); color: var(--odyssey-hud-dim); }\r
...
.ohud-group-cap { font-size: var(--ohud-font-10); font-weight: 700; }\r
...
.ohud-slot-cost { position: absolute; left: 3px; bottom: 2px; font-size: var(--ohud-font-8); font-weight: 800; color: var(--odyssey-hud-dim); }\r
.ohud-slot-res { position: absolute; right: 3px; bottom: 2px; font-size: var(--ohud-font-8); font-weight: 800; color: var(--odyssey-purple); }\r
.ohud-slot-cd { position: absolute; top: 2px; right: 3px; font-size: var(--ohud-font-9); font-weight: 800; color: var(--odyssey-hud-warning); }\r
...
.ohud-target-name { font-size: calc(var(--ohud-font-11) * var(--ohud-critical-text-ratio, 1)); font-weight: 700; color: var(--odyssey-hud-text); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }\r
.ohud-target-sub { display: flex; align-items: center; gap: 4px; flex-wrap: wrap; }\r
.ohud-target-zone {\r
  display: inline-block; font-size: var(--ohud-font-8-5); font-weight: 800; letter-spacing: 0.5px;\r
...
.ohud-target-dist { font-size: var(--ohud-font-8-5); font-weight: 700; color: var(--odyssey-hud-dim); }\r
.ohud-target-clear {\r
  align-self: flex-start; margin-top: 1px; padding: 1px 8px; font-size: var(--ohud-font-8-5); font-weight: 700;\r
...
.ohud-target.is-empty .ohud-target-hint { font-size: var(--ohud-font-10); font-weight: 700; color: var(--odyssey-hud-muted); letter-spacing: 0.2px; }\r
.ohud-target-subhint { font-size: var(--ohud-font-8-5); color: var(--odyssey-hud-dim); }\r
\r
/* ===================== Mod + Action column ===================== */\r
...
.ohud-mod {\r
  ...
  height: 17px; font-size: var(--ohud-font-9); padding: 0 6px; border-radius: var(--odyssey-hud-radius-chip);\r
  border: 1px solid var(--odyssey-hud-border); background: var(--odyssey-panel-base); color: var(--odyssey-hud-muted);\r
}\r
...
.ohud-mod--armed .ohud-mod-name { font-size: calc(var(--ohud-font-9) * var(--ohud-critical-text-ratio, 1)); }\r
...
.ohud-mod-remove {\r
  ...
  font-size: var(--ohud-font-11); line-height: 1; padding: 0 0 0 4px; opacity: 0.7;\r
}\r
...
.ohud-econ-pip { font-size: var(--ohud-font-7-5); font-weight: 800; padding: 0 4px; border-radius: 5px; color: var(--odyssey-hud-dim); border: 1px solid var(--odyssey-hud-border); }\r
...
.ohud-action-btn {\r
  ...
  font-size: var(--ohud-font-12); font-weight: 700; letter-spacing: 0.5px;\r
...
.ohud-log-delta { margin-left: auto; font-weight: 700; font-size: var(--ohud-font-9-5); }\r
...
.ohud-log-empty { font-size: var(--ohud-font-10); color: var(--odyssey-hud-dim); display: grid; place-items: center; flex: 1; padding: 8px; }\r
/* Phase 3D.1: ?debug=1-only \u2014 never rendered in normal play. */\r
.ohud-log-debug-btn {\r
  font-size: var(--ohud-font-8); font-weight: 800; letter-spacing: 0.3px; padding: 1px 5px;\r
...
.ohud-log-result-title { font-weight: 700; font-size: var(--ohud-font-10); }\r
...
.ohud-empty-title { font-size: var(--ohud-font-13); font-weight: 800; letter-spacing: 1px; color: var(--odyssey-hud-text); }\r
.ohud-empty-hint { font-size: var(--ohud-font-11); color: var(--odyssey-hud-muted); max-width: 420px; }\r
...
.ohud-toast { position: absolute; left: 50%; bottom: 6px; transform: translateX(-50%);\r
  font-size: calc(var(--ohud-font-11) * var(--ohud-critical-text-ratio, 1)); color: var(--odyssey-hud-text); background: var(--odyssey-panel-base);\r
...
.ohud-tooltip-title { font-size: var(--ohud-font-11); font-weight: 700; color: var(--odyssey-hud-text); }\r
.ohud-tooltip-line { font-size: var(--ohud-font-10); color: var(--odyssey-hud-muted); margin-top: 2px; }\r
\r
...
.ohud-qbe-desc--card .ohud-qbe-desc-name { font-size: var(--ohud-font-14); }\r
.ohud-qbe-desc--card .ohud-qbe-desc-text,\r
.ohud-qbe-desc--card .ohud-qbe-desc-pill,\r
.ohud-qbe-desc--card .ohud-qbe-desc-status { font-size: var(--ohud-font-12); }\r
...
.ohud-qb-card { position: relative; flex: 1 1 0; min-width: 0; max-width: 56px; height: 50px; }\r
.ohud-qb-slot {\r
...
.ohud-qb-card > .ohud-qb-slot { width: 100%; max-width: none; height: 100%; }\r
...
.ohud-qb-slot.is-empty::after { content: "+"; font-size: var(--ohud-font-15); color: var(--odyssey-hud-dim); opacity: 0.5; }\r
...
.ohud-qb-name {\r
  position: absolute; bottom: 0; left: 0; right: 0; font-size: var(--ohud-font-7-5); line-height: 1.2;\r
  text-align: center; padding: 1px 2px; background: rgba(0, 0, 0, 0.4);\r
  white-space: nowrap; overflow: hidden; text-overflow: ellipsis;\r
}\r
.ohud-qb-type { position: absolute; top: 2px; left: 3px; font-size: var(--ohud-font-6-5); font-weight: 800; opacity: 0.85; letter-spacing: 0.3px; }\r
...
.ohud-qb-cd { font-size: calc(var(--ohud-font-10) * var(--ohud-slot-marker-ratio, 1)); font-weight: 800; color: var(--odyssey-hud-warning); }\r
.ohud-qb-active { font-size: calc(var(--ohud-font-10) * var(--ohud-slot-marker-ratio, 1)); font-weight: 800; color: var(--odyssey-hud-state-active); }\r
.ohud-qb-missing { font-size: var(--ohud-font-20); font-weight: 800; }\r
\r
...
.ohud-qb-state {\r
  font-size: calc(var(--ohud-font-10) * var(--ohud-slot-marker-ratio, 1)); font-weight: 800; letter-spacing: 0.2px;\r
...
.ohud-qb-gm-trigger {\r
  position: absolute; right: 2px; bottom: 12px; z-index: 4;\r
  min-width: 18px; height: 16px; padding: 0 4px;\r
  border: 1px solid var(--odyssey-hud-border); border-radius: 5px;\r
  background: rgba(12, 16, 27, 0.92); color: var(--odyssey-hud-muted);\r
  font-size: var(--ohud-font-7); font-weight: 800; letter-spacing: 0.2px;\r
  cursor: pointer;\r
}\r
.ohud-qb-gm-trigger:hover,\r
.ohud-qb-gm-trigger.is-open { border-color: var(--odyssey-cyan); color: var(--odyssey-cyan); }\r
.ohud-qb-gm-trigger:disabled { opacity: 0.55; cursor: default; }\r
.ohud-qb-gm-menu {\r
  position: absolute; right: 0; bottom: calc(100% + 6px); z-index: 8;\r
  min-width: 118px; display: flex; flex-direction: column; gap: 4px;\r
  padding: 6px; border: 1px solid var(--odyssey-hud-border-strong); border-radius: 8px;\r
  background: rgba(8, 12, 20, 0.98); box-shadow: 0 10px 24px rgba(0, 0, 0, 0.35);\r
}\r
.ohud-qb-gm-menu-btn {\r
  width: 100%; min-height: 22px; padding: 4px 8px;\r
  border: 1px solid var(--odyssey-hud-border); border-radius: 6px;\r
  background: rgba(255, 255, 255, 0.04); color: var(--odyssey-hud-text);\r
  font: inherit; font-size: var(--ohud-font-8-5); text-align: left; cursor: pointer;\r
}\r
.ohud-qb-gm-menu-btn:hover { border-color: var(--odyssey-cyan); }\r
.ohud-qb-gm-menu-btn.is-danger:hover { border-color: var(--odyssey-hud-negative); color: var(--odyssey-hud-negative); }\r
.ohud-qb-gm-menu-btn:disabled { opacity: 0.55; cursor: default; }\r
\r
...
.ohud-qbe-header-title {\r
  font-size: var(--ohud-font-14); font-weight: 800; letter-spacing: 1.1px; text-transform: uppercase;\r
  color: var(--odyssey-hud-text); text-shadow: 0 0 10px rgba(93, 169, 255, 0.3);\r
}\r
.ohud-qbe-header-subtitle {\r
  font-size: var(--ohud-font-10); color: var(--odyssey-hud-muted);\r
...
.ohud-qbe-close {\r
  ...
  font-size: var(--ohud-font-15); line-height: 1; color: var(--odyssey-hud-muted);\r
...
.ohud-qbe-section-label {\r
  flex: 0 0 auto; font-size: var(--ohud-font-10); font-weight: 800; letter-spacing: 0.8px;\r
  color: var(--odyssey-hud-muted); text-transform: uppercase;\r
}\r
.ohud-qbe-hint { flex: 0 0 auto; font-size: var(--ohud-font-9-5); color: var(--odyssey-hud-dim); margin-top: -3px; }\r
.ohud-qbe-lib-empty, .ohud-qbe-empty { font-size: var(--ohud-font-10); color: var(--odyssey-hud-muted); padding: 8px 4px; }\r
\r
...
.ohud-qbe-desc-placeholder {\r
  ...
  font-size: var(--ohud-font-10-5); color: var(--odyssey-hud-dim); padding: 10px;\r
}\r
...
.ohud-qbe-desc-name { font-size: var(--ohud-font-13); font-weight: 800; color: var(--odyssey-hud-text); }\r
.ohud-qbe-desc-type { font-size: var(--ohud-font-9); font-weight: 700; letter-spacing: 0.4px; color: var(--odyssey-hud-muted); }\r
.ohud-qbe-desc-text { font-size: var(--ohud-font-10-5); line-height: 1.4; color: var(--odyssey-hud-muted); }\r
.ohud-qbe-desc-pills { display: flex; flex-wrap: wrap; gap: 5px; }\r
.ohud-qbe-desc-pill {\r
  font-size: var(--ohud-font-9); font-weight: 700; padding: 2px 7px; border-radius: 999px;\r
...
.ohud-qbe-desc-status { font-size: var(--ohud-font-10); font-weight: 700; padding: 4px 8px; border-radius: 6px; }\r
...
.ohud-qbe-card-name {\r
  font-size: var(--ohud-font-11-5); font-weight: 700; color: var(--odyssey-hud-text);\r
  overflow: hidden; text-overflow: ellipsis; white-space: nowrap;\r
}\r
.ohud-qbe-card-type { font-size: var(--ohud-font-8-5); font-weight: 700; letter-spacing: 0.4px; color: var(--odyssey-hud-muted); }\r
.ohud-qbe-card-badges { flex: 0 0 auto; display: flex; flex-direction: column; align-items: flex-end; gap: 3px; }\r
.ohud-qbe-badge {\r
  font-size: var(--ohud-font-8); font-weight: 800; letter-spacing: 0.2px; white-space: nowrap;\r
...
.ohud-qbe-card-off { flex: 0 0 auto; font-size: var(--ohud-font-9); font-weight: 800; color: var(--odyssey-hud-warning); }\r
\r
...
.ohud-qbe-slot.is-empty::after { content: "+"; font-size: var(--ohud-font-17); color: var(--odyssey-hud-dim); opacity: 0.5; }\r
...
.ohud-qbe-slot-idx { position: absolute; top: 2px; left: 3px; font-size: var(--ohud-font-7); font-weight: 800; color: var(--odyssey-hud-dim); }\r
.ohud-qbe-slot-type { position: absolute; top: 2px; right: 3px; font-size: var(--ohud-font-6); font-weight: 800; opacity: 0.75; }\r
.ohud-qbe-slot-icon { width: 18px; height: 18px; }\r
.ohud-qbe-slot-name {\r
  position: absolute; bottom: 1px; left: 1px; right: 1px; font-size: var(--ohud-font-5-5); text-align: center;\r
  background: rgba(0, 0, 0, 0.45); border-radius: 0 0 6px 6px; padding: 0 1px;\r
  overflow: hidden; text-overflow: ellipsis; white-space: nowrap;\r
}\r
.ohud-qbe-missing { font-size: var(--ohud-font-15); font-weight: 800; }\r
.ohud-qbe-remove {\r
  position: absolute; top: -5px; right: -5px; width: 14px; height: 14px; padding: 0;\r
  display: grid; place-items: center; font-size: var(--ohud-font-10); line-height: 1; border-radius: 50%;\r
...
.ohud-qbe-conflict {\r
  ...
  font-size: var(--ohud-font-10); color: var(--odyssey-hud-warning);\r
  background: rgba(255, 194, 75, 0.12); border: 1px solid rgba(255, 194, 75, 0.4);\r
  border-radius: 8px; padding: 6px 10px;\r
}\r
.ohud-qbe-reload {\r
  flex: 0 0 auto; font-size: var(--ohud-font-9); font-weight: 800; color: var(--odyssey-hud-warning);\r
...
.ohud-qbe-status { font-size: var(--ohud-font-10); font-weight: 600; color: var(--odyssey-hud-dim); }\r
...
.ohud-qbe-btn {\r
  padding: 6px 14px; font-size: var(--ohud-font-11); font-weight: 700; border-radius: 7px; cursor: pointer;\r
...
.ohud-moderr-title { font-size: var(--ohud-font-11); font-weight: 800; color: var(--odyssey-hud-negative); }\r
.ohud-moderr-detail {\r
  font-size: var(--ohud-font-9); line-height: 1.3; color: var(--odyssey-hud-muted);\r
...
.ohud-module-debug {\r
  ...
  font-size: var(--ohud-font-8); font-weight: 700; letter-spacing: 0.3px;\r
...
.ohud-module[data-module="player"] .ohud-player-name { font-size: calc(var(--ohud-font-16) * var(--ohud-critical-text-ratio, 1)); }\r
.ohud-module[data-module="player"] .ohud-res-num { font-size: calc(var(--ohud-font-12) * var(--ohud-critical-text-ratio, 1)); }\r
.ohud-module[data-module="player"] .ohud-res-label { font-size: var(--ohud-font-9); }\r
.ohud-module[data-module="player"] .ohud-res-track { height: 8px; }\r
.ohud-module[data-module="player"] .ohud-pip { font-size: calc(var(--ohud-font-9) * var(--ohud-critical-text-ratio, 1)); padding: 2px 8px; }\r
.ohud-module[data-module="player"] .ohud-chip-status { font-size: var(--ohud-font-9-5); }\r
\r
...
.ohud-weapon-option {\r
  ...
  font-size: var(--ohud-font-8); text-align: left;\r
}\r
...
.ohud-weapon-option-type,\r
.ohud-weapon-option-ammo { color: var(--odyssey-hud-muted); font-size: var(--ohud-font-7-5); }\r
...
.ohud-firemode-list.is-empty {\r
  ...
  min-height: 18px; color: var(--odyssey-hud-muted); font-size: var(--ohud-font-9); text-align: center;\r
}\r
.ohud-reserve-mag,\r
.ohud-firemode-option {\r
  ...
  border: 1px solid var(--odyssey-hud-border); border-radius: 5px;\r
  background: rgba(10, 16, 31, 0.74); color: var(--odyssey-hud-text);\r
  font-size: var(--ohud-font-9); white-space: nowrap;\r
}\r
...
.ohud-debuglog-clear {\r
  font-size: var(--ohud-font-8); font-weight: 700; padding: 1px 6px;\r
  border: 1px solid var(--odyssey-hud-border); border-radius: 6px;\r
...
.ohud-debuglog-row {\r
  display: flex; gap: 5px; align-items: baseline; font-size: var(--ohud-font-8-5); line-height: 1.3;\r
...
.ohud-debuglog-empty { font-size: var(--ohud-font-10); color: var(--odyssey-hud-dim); display: grid; place-items: center; flex: 1; padding: 8px; }\r
\r
...
.ohud-cc-modsec-head { font-size: var(--ohud-font-8-5); font-weight: 800; letter-spacing: 0.4px; color: var(--odyssey-hud-muted); text-transform: uppercase; }\r
.ohud-cc-modsec[data-modifier-state="empty"] .ohud-cc-modsec-head { opacity: 0.65; }\r
.ohud-cc-modsec-empty { font-size: var(--ohud-font-8-5); color: var(--odyssey-hud-dim); }\r
.ohud-cc-modsec-chips { display: flex; gap: 3px; flex-wrap: nowrap; overflow: hidden; }\r
.ohud-cc-modsec-chips .ohud-mod { flex: 1 1 0; min-width: 0; height: auto; min-height: 16px; font-size: var(--ohud-font-8-5); padding: 1px 5px; }\r
...
.ohud-cc-abtn {\r
  ...
  font-size: calc(var(--ohud-font-11) * var(--ohud-critical-text-ratio, 1)); font-weight: 800; letter-spacing: 0.4px;\r
...
.ohud-bind-badge {\r
  ...
  font-size: var(--ohud-font-9); font-weight: 800; letter-spacing: 0.5px;\r
...
.ohud-bind-name {\r
  font-size: var(--ohud-font-16); font-weight: 800; color: var(--odyssey-hud-text);\r
  overflow: hidden; text-overflow: ellipsis; white-space: nowrap;\r
}\r
.ohud-bind-status { font-size: var(--ohud-font-10); color: var(--odyssey-hud-muted); }\r
.ohud-bind-owner { font-size: var(--ohud-font-9); color: var(--odyssey-hud-muted); opacity: 0.8; }\r
\r
...
.ohud-bind-fallback-label { font-size: var(--ohud-font-10); font-weight: 700; color: var(--odyssey-hud-muted); }\r
.ohud-bind-fallback-hint { font-size: var(--ohud-font-8-5); color: var(--odyssey-hud-muted); opacity: 0.7; }\r
\r
/* Dev-only (?debug=1) error detail under a Player prompt. */\r
.ohud-bind-dev { font-size: var(--ohud-font-8); color: var(--odyssey-hud-muted); opacity: 0.6; margin-top: 4px; word-break: break-word; }\r
\r
...
.ohud-editor-title { font-size: var(--ohud-font-13); font-weight: 800; letter-spacing: 0.5px; color: var(--odyssey-hud-text); }\r
.ohud-editor-hint { font-size: var(--ohud-font-11); color: var(--odyssey-hud-muted); }\r
.ohud-editor-actions { margin-left: auto; display: flex; gap: 8px; }\r
.ohud-editor-btn {\r
  font: inherit; font-size: var(--ohud-font-12); font-weight: 700; cursor: pointer;\r
...
.ohud-card-name { font-size: var(--ohud-font-10); font-weight: 700; color: var(--odyssey-hud-text); }\r
