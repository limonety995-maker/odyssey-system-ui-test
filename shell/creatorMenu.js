...
function buildPanelMarkup(state, access) {
  ...
  const filtersMarkup = state.activeTab === "calibers"
  ...
  const editorMarkup = state.activeTab === "calibers"
  ...
  const catalogCollapsed = state.activeTab === "calibers"
...
export function mountCreatorMenu({
  ...
  async function loadListForTab(kind, settings, requestId = state.requestNonce) {
    ...
    if (
      ...
      state.drafts[kind] = kind === "calibers"
  ...
  async function saveDraft() {
    ...
    try {
      ...
      const result = state.activeTab === "calibers"
